...
public class CustomerFactoryIT {
  ...
  /** Es una variable que utilizaremos para crear customers gracias a su método create, de modo es un obdeto
  ...
  /** Es el objeto que utilizamos para crear la conexión con la base de datos de la cual implementaremos los métodos 
   *  con la clase JdbcDatabaseTester.
   */
...
//    log4j:WARN Please initialize the log4j system properly.  
  ...
  public void setUp() throws Exception {
    ...
    //Un dataset, como su nombre indica es una colección de tablas con datos varios
  ...
  public void testInsert() throws Exception {
    Customer customer = _customerFactory.create(12,"Johnathan", "Smithsonian");
    customer.setStreet("2 Secondary Street");
    ...
    //Una table es una tabla de datos obtenida a partir de un dataset
    DataFileLoader loader = new FlatXmlDataFileLoader();
